...
<h3 align="center"><b>js-ipfs-http-client publish and resolve</b></h3>

<p align="center">
  <b><i>Upload and publish a file to IPFS via the browser using js-ipfs-http-client!</i></b>
  <br />
  <br />
  ...
  ·
  <a href="https://githubbox.com/ipfs-examples/js-ipfs-examples/tree/master/examples/http-client-name-api">View Demo</a>
  ·
